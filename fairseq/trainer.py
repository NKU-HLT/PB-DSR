...
class Trainer(object):
    ...
    def get_valid_iterator(
        ...
        batch_iterator = self.task.get_batch_iterator(
            ...
            max_tokens=self.cfg.dataset.max_tokens_valid, # 3200000
            max_sentences=self.cfg.dataset.batch_size_valid, # none
            max_positions=utils.resolve_max_positions(
                self.task.max_positions(),
                self.model.max_positions(),
            ),
            ignore_invalid_inputs=self.cfg.dataset.skip_invalid_size_inputs_valid_test, # false
            required_batch_size_multiple=self.cfg.dataset.required_batch_size_multiple, # 8
