...
def parse_args_and_arch(
    ...
    #-------wsy add for s2s-----------------
    # 找到了设置命令行参数的地方：
    from wsy.code import hparam
    if hparam.task=="s2st":
        args.arch="s2ut_transformer_fisher"
    ...
    if hparam.task=="s2st":
        ...
        args.save_dir="/home/wangshiyao/wangshiyao_space/fairseq/wsy/training_log"
        args.lr=[0.0005]
        ...
        args.update_freq=[4]
        args.fp16=True
        args.tensorboard_logdir="/home/wangshiyao/wangshiyao_space/fairseq/wsy/training_log"
        args.num_workers=8
    #--------------------------------------------------------------------------------------------------
    # Post-process args.
    if (
