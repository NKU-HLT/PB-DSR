...
from wsy import hparam as hp # wsy add
...
class HubertEncoder(FairseqEncoder):
    def __init__(self, cfg: HubertAsrConfig, task):
        ...
        # assert cfg.normalize == w2v_args.task.normalize, ( # wsy 注释
        ...
        # 报错：omegaconf.errors.ConfigAttributeError: Key 'autoregressive' not in 'HubertCtcConfig'
    ...
    def forward(self, source, padding_mask, tbc=True, **kwargs):
        ...
        # }
        # if hp.knn_aug or hp.prepare_datastore or hp.use_cl_loss:
        if hp.prepare_datastore or hp.use_cl_loss:
            return {
                "encoder_out": x,  # T x B x C
                "encoder_padding_mask": padding_mask,  # B x T
                "padding_mask": padding_mask,
                "hubert_feature":tmp_x
            }
        else:
            return {
            "encoder_out": x,  # T x B x C
